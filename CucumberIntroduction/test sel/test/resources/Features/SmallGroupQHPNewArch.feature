@SGQHPNEWARCH
Feature: Small Group QHP - New Architechture - Member & Employer - HMO/EPO/PPO 


Scenario Outline: Reg No - <Regression case No> - SG QHP PEGA FLOW - New Arch - Links verification - Member - for <MemberType> - <MemberIdValue>
...
@SGQHPMEMBERSTAGE03 @DAILYREGRESSIONRUNTST03 @FORMS03
Examples:
| Regression case No |MemberIdValue| Password |MemberType|Endpoint|
| SGQHPMEM01 | 2665981 | Today1234 | HMO |http://facetstest3api.hap.org/Memberservice/Memberservice.asmx|
| SGQHPMEM02 | 10031273 | Today1234 | HMO |http://facetstest3api.hap.org/Memberservice/Memberservice.asmx|

@SGQHPMEMBERSTAGE02 @DAILYREGRESSIONRUNTST02 @FORMS02
Examples:
| Regression case No | MemberIdValue| Password |MemberType|Endpoint|
| SGQHPMEM01 | 2665981 | Today1234 | HMO |https://facetstest2api.hap.org/Memberservice/Memberservice.asmx|
| SGQHPMEM02 | 10031273 | Today1234 | HMO |https://facetstest2api.hap.org/Memberservice/Memberservice.asmx|

Scenario Outline: Reg No - <Regression case No> - SMALL GROUP QHP - New Arch - Links verification- Employer- for <MemberType> - <GroupIdValue>
...
@SGQHPEMPLOYERSTAGE03 @DAILYREGRESSIONRUNTST03 @CONTRACTSRIDERS03
Examples:
		| Regression case No | GroupIdValue | MemberType | Password |
		| SGQHPEMP01 | 10003449 | PPO | Today1234 |
		| SGQHPEMP02 | 20001828 | PPO | Today1234 |
		| SGQHPEMP03 | 10001187 | PPO | Today1234 |


@SGQHPEMPLOYERSTAGE02 @DAILYREGRESSIONRUNTST02 @CONTRACTSRIDERS02
Examples:
		| Regression case No | GroupIdValue | MemberType | Password |
		| SGQHPEMP01 | 10003449 | PPO | Today1234 |
		| SGQHPEMP02 | 20001828 | PPO | Today1234 |
