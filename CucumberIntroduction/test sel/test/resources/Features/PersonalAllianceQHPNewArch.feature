@PAQHPNEWARCH 
Feature: Personal Alliance QHP - New Architechture - Member & Employer - HMO/EPO/PPO 


Scenario Outline: Reg No - <Regression case No> - Personal Alliance QHP - New Arch - Links verification for <MemberType> - <MemberIdValue>
...
@PAQHPMEMBERSTAGE03 @DAILYREGRESSIONRUNTST03 @FORMS03
Examples:
| Regression case No | MemberIdValue | Password | MemberType |Endpoint|
| PAQHPMEM01 | 3130146 | Today1234 | HMO |http://facetstest3api.hap.org/Memberservice/Memberservice.asmx|
#| PAQHPMEM02 | 11029649 | Today1234 | HMO |http://facetstest3api.hap.org/Memberservice/Memberservice.asmx|
#| PAQHPMEM03 | 10555543 | Today1234 | HMO |http://facetstest3api.hap.org/Memberservice/Memberservice.asmx|
#| PAQHPMEM04 | 10256450 | Today1234 | PPO |http://facetstest3api.hap.org/Memberservice/Memberservice.asmx|

@PAQHPMEMBERSTAGE02 @DAILYREGRESSIONRUNTST02 @FORMS02
Examples:
| Regression case No | MemberIdValue | Password | MemberType |Endpoint|
| PAQHPMEM01 | 3130146 | Today1234 | HMO |https://facetstest2api.hap.org/Memberservice/Memberservice.asmx|
#| PAQHPMEM02 | 11029649 | Today1234 | HMO |https://facetstest2api.hap.org/Memberservice/Memberservice.asmx|
#| PAQHPMEM03 | 10555543 | Today1234 | HMO |https://facetstest2api.hap.org/Memberservice/Memberservice.asmx|
#| PAQHPMEM04 | 10256450 | Today1234 | PPO |https://facetstest2api.hap.org/Memberservice/Memberservice.asmx|

Scenario Outline: Reg No - <Regression case No> - Personal Alliance QHP - Links verification- Employer- New Arch for <MemberType> - <GroupIdValue>
...
@PAQHPEMPLOYERSTAGE03 @DAILYREGRESSIONRUNTST03 @CONTRACTSRIDERS03
Examples:
		| Regression case No | GroupIdValue | MemberType | Password |
		| PAQHPEMP01|  10000005 | PPO | Today1234 |

@PAQHPEMPLOYERSTAGE02 @DAILYREGRESSIONRUNTST02 @CONTRACTSRIDERS02
Examples:
		| Regression case No | GroupIdValue | MemberType | Password |
		| PAQHPEMP01 | 10000005 | PPO | Today1234 |