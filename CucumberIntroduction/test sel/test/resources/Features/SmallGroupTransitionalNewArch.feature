@SGTRANSNEWARCH 
Feature: Small Group Transitional - New Architechture - Member & Employer - HMO/EPO/PPO 


Scenario Outline: Reg No - <Regression case No> - Small Group Transitional - New Arch - Links verification for <MemberType> - <MemberIdValue>
...
@SGTRANSNEWARCHMEMBERSTAGE03 @DAILYREGRESSIONRUNTST03 @FORMS03
Examples:
| Regression case No | MemberIdValue | Password | MemberType |Endpoint|
| SGTRANSMEM01 | 1270689 | Today1234 | EPO |http://facetstest3api.hap.org/Memberservice/Memberservice.asmx|

@SGTRANSNEWARCHMEMBERSTAGE02 @DAILYREGRESSIONRUNTST02 @FORMS03
Examples:
| Regression case No | MemberIdValue | Password | MemberType |Endpoint|
| SGTRANSMEM01 | 1270689 | Today1234 | EPO |https://facetstest2api.hap.org/Memberservice/Memberservice.asmx|


Scenario Outline: Reg No - <Regression case No> - Small Group Transitional - Links verification- Employer- New Arch for <MemberType> - <GroupIdValue>
...
@SGTRANSNEWARCHEMPLOYERSTAGE03 @DAILYREGRESSIONRUNTST03 @CONTRACTSRIDERS03
Examples:
		| Regression case No | GroupIdValue | MemberType | Password |
		| SGTRANSEMP01|  10003144 | EPO | Today1234 |

@SGTRANSNEWARCHEMPLOYERSTAGE02 @DAILYREGRESSIONRUNTST02 @CONTRACTSRIDERS02
Examples:
		| Regression case No | GroupIdValue | MemberType | Password |
		| SGTRANSEMP01|  10003144 | EPO | Today1234 |