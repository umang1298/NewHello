 @ASONEWARCH
Feature: ASO - New Architechture - Member & Employer  


Scenario Outline: Reg No - <Regression case No> - ASO - Links verification for <MemberType> - <MemberIdValue>
...
@ASOMEMBERSTAGE03 @DAILYREGRESSIONRUNTST03 @FORMS03
Examples:
| Regression case No | MemberIdValue | Password | MemberType |Endpoint|
| ASOMEM01 | 2311429 | Today1234 | HMO |http://facetstest3api.hap.org/Memberservice/Memberservice.asmx|

@ASOMEMBERSTAGE02 @DAILYREGRESSIONRUNTST02 @FORMS02
Examples:
| Regression case No | MemberIdValue | Password | MemberType |Endpoint|
| ASOMEM01 | 2311429 | Today1234 | HMO |https://facetstest2api.hap.org/Memberservice/Memberservice.asmx|

Scenario Outline: Reg No - <Regression case No> - ASO - Links verification- Employer- New Arch for <MemberType> - <GroupIdValue>
...
@ASOEMPLOYERSTAGE03 @DAILYREGRESSIONRUNTST03 @CONTRACTSRIDERS03
Examples:
		| Regression case No | GroupIdValue | MemberType | Password |
		| ASOEMP01|  10000702 | PPO | Today1234 |

@ASOEMPLOYERSTAGE02 @DAILYREGRESSIONRUNTST02 @CONTRACTSRIDERS02
Examples:
		| Regression case No | GroupIdValue | MemberType | Password |
		| ASOEMP01 | 10000702 | PPO | Today1234 |