...
public class MyScreenRecorder extends ScreenRecorder {
	...
	public static void startRecording(String methodName) throws Exception {
		...
		File file = new File(System.getProperty("user.dir")+File.separator+ "target/recordings"+File.separator);
		...
		screenRecorder = new MyScreenRecorder(gc, captureSize,
				...
				null, file, methodName.replaceAll(" ", "_").replaceAll("\"", "_"));
		System.out.println("Starting the recording");
		screenRecorder.start();

	}
	
	public static void stopRecording(String methodName) throws Exception {
		screenRecorder.stop();
	}
